              ...
              <div className="form-grid">
                ...
                <label className="field full-width">
                  ...
                  <small className="form-hint">
                    {copy(
  "与 Android v33 使用相同的可配置请求标识；不能为空或包含控制字符。",
  "Uses the same configurable request identifier as Android v33; it cannot be blank or contain control characters.",
                    )}
                  </small>
                </label>
...
export default function CloudSyncPage() {
  ...
  return (
    <PageFrame
      ...
      description={copy(
  "同步日记、媒体与 Android v33 应用 JSON；手机使用时间仅按需从 Android usage 对象下载并显示。本地文件仍是最终来源。",
  "Sync diaries, media and Android v33 app JSON; phone screen time is downloaded from Android usage objects only when selected. Local files remain the source of truth.",
      )}
      actions={
        <>
