    ...
    <>
      ...
      <section className="panel settings-section">
        <SettingsSectionHeading
          ...
          description={tr(
            "选择 Windows 首页显示的模块；列表顺序使用 Android v27 的稳定模块 ID。",
            "Choose Home modules. The list uses the stable module IDs from Android v27.",
          )}
        />
  ...
  return (
    <>
      ...
      <aside className="panel compatibility-note">
        ...
        <div>
          <h2>{tr("Android v27 兼容", "Android v27 compatibility")}</h2>
          <p>{tr(
