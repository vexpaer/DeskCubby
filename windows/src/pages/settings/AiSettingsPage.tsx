...
export default function AiSettingsPage() {
  ...
  return (
    <PageFrame
      ...
      description={t(
        "配置与 Android v27 使用相同字段。API Key 按产品约定明文保存、完整显示并进入 v27 备份，但不会写入日志、错误或请求预览。",
        "Configurations use the Android v27 fields. By product design, API keys are stored in plaintext, shown in full and included in v27 backup, but never written to logs, errors or request previews.",
      )}
      actions={
        <>
