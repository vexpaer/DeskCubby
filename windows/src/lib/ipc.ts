...
export function readableError(
  ...
  const zh: Record<string, string> = {
    ...
    backup_invalid: "备份文件无效或不符合 Android v1–v33 格式。",
    backup_version_unsupported: "仅支持 Android v1–v33 备份。",
    compatibility_shadow_corrupt:
      "兼容备份数据已损坏，无法安全保留未知字段，请重新导入有效的 v1–v33 备份。",
    ...
    usage_statistics_invalid: "手机使用时间文件无效，仅支持 Android v4 统计文件或含 usageDevices 的 v33 备份。",
  ...
  const en: Record<string, string> = {
    ...
    backup_invalid: "The backup is invalid or is not an Android v1–v33 backup.",
    backup_version_unsupported: "Only Android v1–v33 backups are supported.",
    compatibility_shadow_corrupt:
      "Compatibility backup data is corrupt, so unknown fields cannot be preserved safely. Import a valid v1–v33 backup again.",
    ipc_protocol_incompatible:
    ...
    usage_statistics_invalid:
      "The phone screen-time file is invalid. Use Android v4 statistics or a v33 backup containing usageDevices.",
